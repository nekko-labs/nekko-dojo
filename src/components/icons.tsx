...
/**
 * Discord's wordless mark. The path is the official one and is drawn to fill
 * the 24x24 box exactly (bbox x 0→24, y 2.85→21.14): an approximated redraw
 * overflows the viewBox on the right and clips the wing, so do not hand-tweak
 * these numbers.
 */
