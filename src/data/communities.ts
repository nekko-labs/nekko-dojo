...
export const projects: Project[] = [
  ...
  },
  {
    ...
    url: 'https://github.com/nekkolabs',
    description:
      'Nekko Labs builds in the open. Contribute to our projects alongside working engineers, pair on issues, and learn how a real team ships software. Start in the Discord to find an issue that fits you.',
    region: 'Japan',
    tags: ['TypeScript', 'Open Source', 'Mentorship'],
    beginnerFriendly: true,
    featured: true,
  },
  {
